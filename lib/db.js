...
제8조(비용 부담 및 정산) ① "API 유료" 자료 이용에 따라 외부 제공자(OpenAI 등)에게 발생하는 실비는 이용자가 부담하며, 회사는 실사용량을 측정·집계하여 실비를 배분·청구합니다(pass-through, 부가가치세 별도). ② 각 이용자·수업·자료에 대한 배분액은 제공자의 실제 청구액을 기준으로 측정된 API 호출 비율(배분액 = 실청구액 × 대상 호출수 ÷ 해당 제공자 전체 호출수)로 산정하고, 배분 총액은 청구서 총액과 일치합니다. ③ 이용자는 플랫폼이 기록하는 사용량 집계를 정산의 근거 자료로 인정합니다. ④ 정산은 월별로 하며, 회사는 익월 5영업일 이내 배분 내역을 통지하고 이용자는 통지일로부터 14일 이내에 납부합니다. ⑤ 기한 내 미납 시 회사는 연 12%의 지연손해금을 청구할 수 있고, 7일 이상의 기간을 정해 최고한 후에도 납부가 없으면 이용을 정지할 수 있습니다.

제9조(권한과 역할) ① 이용자는 부여받은 범위에서만 강사·학생 관리, 웹앱 배정, 접속 기록·리포트 열람, 수업·시간표 운영을 수행합니다. ② 관리자 계정의 생성·임명·권한 변경은 슈퍼관리자 전용이며, 이용자는 자신보다 낮은 권한의 계정만 발급할 수 있습니다. ③ 이용자는 부여된 권한을 제3자에게 재위임·양도하지 않으며, 자신이 관리하는 강사·학생이 본 계약을 준수하도록 감독할 의무를 지고, 감독 의무를 다하지 못한 범위(고의 또는 중대한 과실 포함)에서 그 위반에 대해 책임을 집니다.

제10조(계약 기간 및 해지) ① 본 계약의 기간은 서명일로부터 1년으로 하며, 만료 30일 전까지 서면 이의가 없으면 동일 조건으로 1년씩 자동 갱신됩니다. ② 각 당사자는 30일 전 서면 통지로 계약을 해지할 수 있습니다. ③ 상대방이 본 계약을 중대하게 위반하거나 정산금을 기한 내 납부하지 않는 경우, 14일 이상의 기간을 정해 시정을 최고하고 그 기간 내 시정되지 않으면 계약을 즉시 해지할 수 있습니다. ④ 계약 종료 시 회사는 이용자 계정·데이터를 30일 이내 처리·파기하며(법령상 보존 의무 정보는 예외), 미정산분은 종료일 기준으로 청산합니다.

제11조(손해배상) ① 일방이 본 계약을 위반하여 상대방에게 손해를 입힌 경우 직접적·통상적 손해를 배상하며, 각 당사자의 배상책임 총액은 손해 발생일 기준 직전 12개월간 이용자가 회사에 지급한 이용료 합계를 한도로 합니다. ② 다만 고의 또는 중대한 과실, 제2조(비밀유지)·제4조(개인정보) 위반, 제3자 지식재산권 침해의 경우에는 위 한도를 적용하지 않습니다. ③ 개인정보 유출 등 사고 발생 시 이용자는 지체 없이 회사에 통지하고 대응에 협조합니다.

제12조(불가항력) 천재지변, 전쟁, 정전, 통신 장애, 외부 서비스 제공자(클라우드·API 등)의 장애 등 당사자의 합리적 통제를 벗어난 사유로 인한 의무 불이행에 대해서는 책임을 지지 않습니다. 다만 이미 발생한 정산금 지급 의무는 면제되지 않습니다.

제13조(통지) 본 계약에 따른 통지는 서면·전자우편·플랫폼 내 알림으로 하며, 상대방에게 도달한 때(전자적 통지는 발송한 때) 효력이 발생합니다. 이용자는 연락처 변경 시 지체 없이 회사에 알립니다.

제14조(일반조항) ① 일부 조항이 무효·집행 불능이더라도 나머지 조항의 효력에는 영향을 미치지 않습니다. ② 어느 당사자가 권리를 행사하지 않은 것이 그 권리의 포기로 간주되지 않습니다. ③ 본 계약은 그 대상에 관한 당사자 간의 완전한 합의입니다.

제15조(준거법 및 관할) 본 계약은 대한민국 법에 따라 해석되며, 관련 분쟁은 회사 본점 소재지를 관할하는 법원을 제1심 관할 법원으로 합니다.`;
