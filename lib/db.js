...
제8조(비용 부담 및 정산) ① "API 유료" 자료 이용에 따라 외부 제공자에게 발생하는 실비의 부담 주체는 회사가 정한 정책에 따릅니다. ② 이용료는 제공자의 실제 청구액을 기준으로 하며, 각 이용자·수업·자료에 대한 배분액은 측정된 API 호출 비율(배분액 = 실청구액 × 대상 호출수 ÷ 해당 제공자 전체 호출수)로 산정하고, 배분 총액은 청구서 총액과 일치합니다. ③ 이용자는 플랫폼이 기록하는 사용량 집계를 정산의 근거 자료로 인정하며, 회사가 통지한 배분 내역을 정해진 기한 내에 납부합니다.

제9조(권한과 역할) ① 이용자는 부여받은 범위에서만 강사·학생 관리, 웹앱 배정, 접속 기록·리포트 열람, 수업·시간표 운영을 수행합니다. ② 관리자 계정의 생성·임명·권한 변경은 슈퍼관리자 전용이며, 이용자는 자신보다 낮은 권한의 계정만 발급할 수 있습니다. ③ 이용자는 부여된 권한을 제3자에게 재위임·양도하지 않으며, 자신이 관리하는 강사·학생이 본 동의서를 준수하도록 감독합니다.

제10조(계약 기간 및 해지) ① 본 동의의 기간·갱신 및 해지 조건은 회사와 이용자가 별도로 정한 계약에 따릅니다. ② 이용자가 본 동의서를 중대하게 위반하거나 정산금을 기한 내 납부하지 않는 경우 회사는 최고 후 이용을 정지·해지할 수 있습니다. ③ 계약 종료 시 계정·데이터는 회사 정책에 따라 처리되며, 미정산분은 종료일 기준으로 청산합니다.

제11조(손해배상 및 준거법) ① 이용자가 본 동의서를 위반하여 회사 또는 제3자에게 손해를 입힌 경우 그 손해를 배상하며, 배상 한도는 회사와 이용자가 정한 계약에 따릅니다. ② 개인정보 유출 등 사고 발생 시 이용자는 지체 없이 회사에 통지하고 대응에 협조합니다. ③ 본 동의는 대한민국 법에 따르며, 분쟁은 회사 본점 소재지를 관할하는 법원을 1심 관할로 합니다.`;
